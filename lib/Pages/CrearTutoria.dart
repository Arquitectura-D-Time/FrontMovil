...
class CrearTutoriaUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ///////////////////////////////////
    var nameText = Text("Fecha",
        style: TextStyle(fontSize: fontSize, color: Colors.deepOrange));
    var emailText = Text("Hora",
        style: TextStyle(fontSize: fontSize, color: Colors.deepOrange));
    var nickText =
    Text("Cupos", style: TextStyle(fontSize: fontSize, color: Colors.deepOrange));
